    ...
    <div ref={ref} dir="rtl" style={{ width: '100%', height: 280 }}>
      <ResponsiveContainer>
        <PieChart>
          ...
          <text x="50%" y="38%" textAnchor="middle" dominantBaseline="central" style={{ fontSize: 24, fontWeight: 700, fill: '#1a1a1a', fontFamily: FONT }}>{total}</text>
          <text x="50%" y="48%" textAnchor="middle" style={{ fontSize: 11, fill: '#888', fontFamily: FONT }}>ניתוחים</text>
          <text x="50%" y="56%" textAnchor="middle" style={{ fontSize: 12, fontWeight: 600, fill: withComps > 0 ? '#E24B4A' : '#1D9E75', fontFamily: FONT }}>
